...
def getSchool(schoolid):
    ...
    for line in schoolresult:
     ...
     #       thisSchool.append(getSchoolPercentile(schoolid,"scie"))
            ...
            thisSchool.append((pvs[schoolid]["math"]+pvs[schoolid]["read"]+pvs[schoolid]["scie"])/3)
...
avepv = '(((PV1MATH + PV2MATH + PV3MATH + PV4MATH + PV5MATH)/(5.0))+((PV1READ + PV2READ + PV3READ + PV4READ + PV5READ)/(5.0))+((PV1SCIE + PV2SCIE + PV3SCIE + PV4SCIE + PV5SCIE)/(5.0)))/3'
